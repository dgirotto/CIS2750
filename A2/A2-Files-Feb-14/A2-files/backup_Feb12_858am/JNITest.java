...
public class JNITest extends JFrame implements ActionListener{
   ...
   public static void main(String[] args){
      ...
      while((fieldName=a2.getLValName("fields"))!=null){
         System.out.println(fieldName);
      }
      //System.out.println("The title name is " + a2.getTitleName());
      //System.out.println("the first 2 fields are " + a2.getLValName("fields") + " and " + a2.getLValName("fields") + " and a button " + a2.getLValName("buttons"));
   }
