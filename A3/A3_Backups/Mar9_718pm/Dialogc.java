...
public class Dialogc extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e) {
      if(e.getSource()==newBtn || e.getSource()==newOpt){
	     if(modFlag==true){
            System.out.println("Prompt save");  /* prompt to save the currently open, modified project */
         ...
         if(modFlag==true){
            ...
            System.out.println("No changes made. don't prompt save");
         }		 
         ...
         if(!(saveasName.toLowerCase().contains(".config"))){
            ...
            promptError(saveasName + " ends in config");
         }
         try{
