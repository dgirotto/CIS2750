...
public class Dialogc extends JFrame implements ActionListener{
   ...
   public static void updateStatusBar(){
      if(Dialogc.modF==true && newF==true){
         Dialogc.statusField.setText("untitled : [MODIFIED]");
      }
      else if(modF==true && newF==false){
         Dialogc.statusField.setText(filename + " : [MODIFIED]");
      }
      else if(modF==false && newF==true){
         Dialogc.statusField.setText("untitled : [UNMODIFIED]");
      }
      else{
   ...
   public void actionPerformed(ActionEvent e){
      if(e.getSource() == sendButton){
         ...
         //test if <noExtension>.class exists before calling takeAction()
         takeAction("run");
      }
