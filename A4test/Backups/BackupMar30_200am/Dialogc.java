...
public class Dialogc extends JFrame implements ActionListener{
   ...
   public static void GenCode(){
      ...
      try{
         ...
         output.write("public class " + noExtension + " extends JFrame{\n");
         ...
         /* create an actionlistener class for each button in the Dialog */

         getLValName("buttons"); /* reset buttons list to front */ 
         for(x=0;x<btnCtr;x++){

            buttonName = getLValName("buttons");
            System.out.println("creating actionlistener class for " + buttonName);
            fw = new FileWriter(buttonName + ".java");
            output = new BufferedWriter(fw);

            output.write("import javax.swing.*;\n");
            output.write("import java.awt.event.*;\n");
            output.write("import java.awt.*;\n");
            output.write("public class " + buttonName + " implements ActionListener{\n");
            output.write("public " + buttonName + "(" + noExtension + " mainObj){\n"); // mainObj = name of the GUI object */
            output.write("mainObj.addActionListener(this);\n"); 
            output.write("}\n"); 
